...
/**
 * Servlet implementation class AssEvAdd
 */
public class AssEvAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement ps1 = con.prepareStatement("insert into ev_tbl values(?,?,?,?,?)");
			ps1.setInt(1,0);
			ps1.setString(2,evtitle);
			ps1.setString(3,evdesc);
			...
			{
				response.sendRedirect("AssAddEv.jsp");
			}
		}
		catch(Exception e)
		{
